							...
							<table width="96%" border="1" align="center">
								<tr bgcolor="#66CC99">
                               	...
                               	<jstlcore:forEach items="${regEvents}" var="regEvent" >
									...
									<tr align="center">
										<td><jstlcore:out value="${fn:substring(visitor.lastName,0,4)}${fn:substring(visitor.firstName,0,3)}-${regEvent[6]}"></jstlcore:out></td>
										...
										<a href="<jstlcore:url value="/eventunreg.htm?eventId=${regEvent[0]}"/>">Release</a>
