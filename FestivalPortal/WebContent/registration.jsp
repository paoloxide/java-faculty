 ...
 var XMLHttpRequestObject = false;
		...
		if(XMLHttpRequestObject) {
        			 var userName=document.getElementById("username").value;
                   	 XMLHttpRequestObject.open("GET", "searchUsername.htm?userName="+userName+"&random="+Math.random());

          XMLHttpRequestObject.onreadystatechange = function()
          {
				var resultStatus="";
            		if (XMLHttpRequestObject.readyState == 4 && XMLHttpRequestObject.status == 200) {
            		resultStatus=XMLHttpRequestObject.responseText;
				...
				<tr>
					...
					<table align="center" border="0">
						...
						<tr>
							...
							First Name:</td><td>
							   <input type="text" name="FIRSTNAME" size="25" class="i"></input></td>
					   ...
					   <tr>
							<td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
							User Name:</td><td><input type="text" name="USERNAME" size="25" id="username" onblur=" searchUser();"class="s"></input></td>

					   </tr>
					   <tr>
						    <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
						    Password:</td><td><input type="password" id="password" name="PASSWORD" size="27"></input></td>
